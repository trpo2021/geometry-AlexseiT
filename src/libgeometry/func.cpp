...
void print_triangle(mass_object* triang, float* perimeter, float* area)
{
        ...
        << triang->obj_triangle.point_1[1] << "," << triang->obj_triangle.point_2[0] << ' '
        << triang->obj_triangle.point_2[1] << "," << triang->obj_triangle.point_3[0] << ' '
        << triang->obj_triangle.point_3[1] << "," << triang->obj_triangle.point_4[0] << ' '
